      ...
      <div class="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        >
          ...
          <p class="mt-4 leading-8 text-slate-600">
            ...
            Мне всё равно, кто там что думает, кому я могу нравиться, кто вокруг. Мои глаза горят только при виде тебя. Только ты вызываешь во мне такие чувства. И я правда верю, что судьба связала нас не просто так. Нам остаётся только держаться друг за друга крепче, беречь то, что у нас есть, и идти дальше вместе. Потому что ты мой человек. И без тебя всё было бы совсем не так.


          </p>
        </article>

        <div class="grid grid-cols-2 gap-6" data-page-two-animate>
          <img :src="Our3" alt="Наш кадр" class="h-full min-h-[220px] rounded-[28px] object-cover shadow-lg" />
          <img :src="Our6" alt="Наш кадр" class="h-full min-h-[220px] rounded-[28px] object-cover shadow-lg" />
          <img :src="Our4" alt="Наш кадр" class="col-span-2 mx-auto h-[240px] rounded-[28px] object-cover shadow-lg" />
